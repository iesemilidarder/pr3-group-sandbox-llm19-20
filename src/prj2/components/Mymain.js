        ...
        <main>
            <div className="container">
                <div className="jumbotron my-3">
                    ...
                    <p className="lead">Aquí encontrarás los mejores vuelos al mejor precio, en viajes Emili tenemos
                        conocimiento de todos los vuelos nacionales e internacionales, viajes Emili mas preparados que
                        la mili.</p>
                </div>
            </div>
            <div className="container shadow p-3 mb-5 bg-white rounded my-4">
                <form>
                    ...
                    <div className="row">
                        <div className="col">
                           {/* <h5>Elija un origen.</h5>*/}<label htmlFor="fori"><strong>Elija un origen</strong></label>
                            <input id={"fori"} type="text" className="form-control" placeholder="Origen"/>
                        </div>
                        <div className="col"><label htmlFor="fodest"><strong>Elija un destino.</strong></label>
                            {/*<h5>Elija un destino.</h5>*/}
                            <input id={"fodest"} type="text" className="form-control" placeholder="Destino"/>
                        </div>
                        <div className="col">
                        ...
                        <div className="col">
                            {/*<h5>Elija nº de adultos.</h5>*/}<label htmlFor="numpax"><strong>Elija una fecha de ida.</strong></label>
                            <input id={"numpax"} type="text" className="form-control" placeholder="Número de adultos"/>
                        </div>
                    </div>
